...
import com.hiwei.test.agent.enums.ReturnTypeEnums;
...
public class BaseTemplate {
    ...
    protected void renderCenter(StringBuilder sb) {
        ...
        final ReturnTypeEnums returnType = ReturnTypeEnums.of(returnTypeName);
        sb.append("    java.lang.Object result1 = null;").append('\n');
        sb.append("    ").append(returnTypeName).append(" result2 = ").append(returnType.getInitializeValue()).append(";").append('\n');
        sb.append("    try {\n");
        ...
        sb.append("        result1 = ").append(returnType.typeConversion("result2")).append(";\n");
